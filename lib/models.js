...
(function (root) {
  ...
  const CATALOG = [
    // ===== 美国 =====
    { region: 'us', company: 'OpenAI', models: ['GPT-5.5', 'GPT-5.5 Pro', 'GPT-5.5 Instant'] },
    { region: 'us', company: 'Anthropic', models: ['Claude Fable 5', 'Claude Mythos 5', 'Claude Opus 4.7', 'Claude Sonnet 4.6'] },
    ...
    { region: 'cn', company: 'Zhipu', models: ['GLM-5.2', 'GLM-5.2-Air'] },
    { region: 'cn', company: 'Alibaba', models: ['Qwen3.7-Max', 'Qwen3-Max-Thinking', 'Qwen3.5-Plus'] },
